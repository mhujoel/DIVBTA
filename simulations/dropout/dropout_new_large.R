...
# Define username (replace 'YourUsername' with your actual username or set a custom path)
username <- "YourUsername"  # Replace with your actual username or set a static path
...
prop_plot_path <- file.path("C:", "Users", username, "Dropbox", "Carlisle", "R-diabetes",
                            "Submission_manuscripts", "LnCVR-SAS", "LnCVR-publication_SAS", "Revision", "Reviewer_request2_simulate droput",
                            "prop_significant_dropout_large.pdf")
...
prop_3sigma <- Master_summary %>%
  ...
  group_by(dropout) %>%
  summarise(
    n_3sigma = sum(p_value <= 0.05 & (lnCVR < -0.54865611 | lnCVR > 0.47913146), na.rm = TRUE),
    n_total = n(),
...
sigma_plot_path <- file.path("C:", "Users", username, "Dropbox", "Carlisle", "R-diabetes",
                             "Submission_manuscripts", "LnCVR-SAS", "LnCVR-publication_SAS", "Revision", "Reviewer_request2_simulate droput",
                             "3_sigma_dropout_large.pdf")
...
combined_plot <- p / p_prop / p_3sigma +
  ...
  plot_annotation(
    title = "Impact of MNAR on LnCVR in Large Samples (250/trial arm): A Simulation Study",
    theme = theme(
...
combined_plot_path <- file.path("C:", "Users", username, "Dropbox", "Carlisle", "R-diabetes",
                                "Submission_manuscripts", "LnCVR-SAS", "LnCVR-publication_SAS", "Revision", "Reviewer_request2_simulate droput",
                                "combined_plots_large.pdf")
