...
write.table(as.data.frame(Master_summary %>%
            ...
            file=paste0(current_wd,"/dropout_large.txt"))
...
prop_plot_path <- file.path(current_wd,"prop_significant_dropout_large.pdf")
...
sigma_plot_path <- file.path(current_wd,"3_sigma_dropout_large.pdf")
...
# Save the main plot
plot_path <- file.path(current_wd,"dropout_large.pdf")
...
combined_plot_path <- file.path(current_wd,"combined_plots_large.pdf")
